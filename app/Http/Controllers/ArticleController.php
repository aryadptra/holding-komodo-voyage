...
class ArticleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('landing.articles.index', ['articles' => $articles]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('landing.articles.edit', ['article' => $article]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $article->save();
        return redirect()->route('admin.articles.index')->with('success', 'Category successfully update.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.articles.index')->with('success', 'Article permanenly delete');
    }
