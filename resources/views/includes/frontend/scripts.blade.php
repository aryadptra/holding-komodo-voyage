...
<script src="{{ asset('/backend/assets/vendor_assets/js/apexcharts.min.js') }}"></script>
...
<script src="{{ asset('/backend/assets/theme_assets/js/apexmain.js') }}"></script>
<script src="{{ asset('/backend/assets/theme_assets/js/charts.js') }}"></script>
