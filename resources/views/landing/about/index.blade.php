...
@section('content')
    ...
    @php
        $currentPage = 'About'; // Diambil dari config/config.php
    @endphp
    <div class="row">
        <div class="col-lg-12">
            <x-breadcrumb :title="'About'" :items="[['url' => route('admin.about.index'), 'label' => 'About']]" :current_page="$currentPage" />
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                          ...
                          <a href="{{ route('abouts.edit', [$abouts[0]->id]) }}" class="btn btn-warning text-light"><i
