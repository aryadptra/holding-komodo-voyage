    ...
    <section id="about">
        <div class="container">
            <div class="row about-container">
                ...
                <div class="col-lg-5 background order-lg-2 order-1 wow fadeInRight" {{-- style="background: url('{{ asset('about_image/' . $about[0]->image) }}') center top no-repeat; background-size: cover;"> --}} </div>
                </div>
