            ...
            <div class="card">
                <div class="card-body">
                    <div class="my-3 text-right">
                        <a href="{{ route('admin.categories.create') }}" class="btn btn-sm btn-success"> <i
                                class="fa fa-plus"></i>
                            Create</a>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('categories.edit', [$category->id]) }}"
                                            class="btn btn-sm btn-warning text-light"><i class="fa fa-pencil"></i> Edit</a>

                                        <button class="btn btn-sm btn-danger"
                                            onclick="deleteConfirm('{{ $category->id }}', '{{ $category->name }}')"
                                            data-target="#modalDelete" data-toggle="modal"><i class="fa fa-trash"></i>
                                            Delete</button>
                                    </td>
                                </tr>
                            @endforeach
