...
@section('content')
    ...
    @php
        $currentPage = 'List Categories'; // Diambil dari config/config.php
    @endphp
    <div class="row">
        <div class="col-lg-12">
                            ...
                            <table class="table mb-0 table-borderless data-table" data-sorting="true"
                                ...
                                <tbody>
                                    @foreach ($categories as $data => $category)
                                        <tr>
                                            <td>
                                                <div class="userDatatable-content">{{ $data + 1 }}</div>
                                            </td>
                                            <td>
                                                <div class="d-flex">
                                            ...
                                            <td>
                                                <div class="usercategorytable-content">
                                                    {{ $category->slug }}
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                                                    ...
                                                    <li>
                                                        <form hidden id="deleteForm-{{ $category->id }}"
                                                        ...
                                                        <a href="#" class="remove"
                                                            onclick="document.getElementById('deleteForm-{{ $category->id }}').submit(); return false;">
                                                            <img src="{{ asset('admin/img/svg/trash-2.svg') }}"
                                                                alt="trash-2" class="svg">
                                                        </a>
                                                    </li>
