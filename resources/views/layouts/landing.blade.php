...
<head>
    <meta charset="utf-8">
    <title>Komodo Voyage Indonesia</title>
...
<body>
        ...
        <div class="container">
            ...
            <div id="logo" class="pull-left">
                <a href="#hero">
                    ...
                    <h2 class="d-inline text-light">Komodo Voyage Indonesia</h2>
                </a>
            </div>
            ...
            <nav id="nav-menu-container">
                <ul class="nav-menu">
                    ...
                    <li class="{{ $url == 'destination' ? 'menu-active' : '' }}"><a
                            href="{{ url('destination') }}">Destination</a></li>
  ...
  ============================-->
    <footer id="footer">
        ...
        <div class="container">
            <div class="copyright">
                &copy; Copyright <strong>Komodo Voyage Indonesia</strong>. All Rights Reserved
            </div>
            <div class="credits">
                Designed by <a href="https://bootstrapmade.com/">Arya</a>
            </div>
        </div>
    </footer><!-- #footer -->
